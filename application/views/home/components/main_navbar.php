<nav class="navbar navbar-expand-sm navbar-light fixed-top bg-white shadow" id="mainNavbar">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar">
            <div class="navbar-nav">
                <a class="btn btn-white-muted text-left" href="<?= base_url() ?>data-privacy">Data Privacy</a>
                <a class="btn btn-white-muted text-left" href="<?= base_url() ?>about-us">About Us</a>
            </div>
        </div>
    </div>
</nav>