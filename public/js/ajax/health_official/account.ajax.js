...
getAllAccountsAJAX = () => {
    ...
    if(accountList.length) {
        $.ajax({
            url: `${ HEALTH_OFFICIAL_API_ROUTE }accounts`,
            type: 'GET',
...
addAccountAJAX = () => {
    ...
    $.ajax({
        url: `${ HEALTH_OFFICIAL_API_ROUTE }add-account`,
        type: 'POST',
        headers: AJAX_HEADERS,
        data: data,
        dataType: 'json',
...
deleteAccountAJAX = () => {
    ...
    $.ajax({
        url: `${ HEALTH_OFFICIAL_API_ROUTE }accounts/${ userAccountID }`,
        type: 'DELETE',
        headers: AJAX_HEADERS,
        success: result => {
            if(result) {
...
changePasswordAJAX = () => {
    ...
    $.ajax({
        url: `${ HEALTH_OFFICIAL_API_ROUTE }change-password`,
        type: 'PUT',
        headers: AJAX_HEADERS,
        data: data,
        dataType: 'json',
