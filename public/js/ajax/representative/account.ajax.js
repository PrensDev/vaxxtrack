...
getAllAccountsAJAX = () => {
    ...
    if(accountList.length) {
        $.ajax({
            url: `${ REPRESENTATIVE_API_ROUTE }accounts`,
            type: 'GET',
...
addAccountAJAX = () => {
    ...
    $.ajax({
        url: `${ REPRESENTATIVE_API_ROUTE }add-account`,
        type: 'POST',
        headers: AJAX_HEADERS,
        data: data,
        dataType: 'json',
...
deleteAccountAJAX = () => {
    ...
    $.ajax({
        url: `${ REPRESENTATIVE_API_ROUTE }accounts/${ userAccountID }`,
        type: 'DELETE',
        headers: AJAX_HEADERS,
        success: result => {
            if(result) {
...
changePasswordAJAX = () => {
    ...
    $.ajax({
        url: `${ REPRESENTATIVE_API_ROUTE }change-password`,
        type: 'PUT',
        headers: AJAX_HEADERS,
        data: data,
        dataType: 'json',
